...
- Verification notes: Assigned to the `GameScreen` `ArenaEntryHorn` player and played once when a chess arena opens.

### Check & Conquer theme

- Creator: user-provided, generated by the project owner with Suno
- Source URL: not supplied
- License: user-provided for this project; confirm the applicable Suno plan terms before a public commercial release
- Date acquired: 2026-09-11
- Original archive/file: `check-and-conquer-theme.ogg` (SHA-256 `e2ee15553537b4049aad5fd559c2ecf019bf531697beb64cbb2b9dcd6a3f563e`)
- Files used in project: `assets/audio/check-and-conquer-theme.ogg`
- Modifications: Relocated from the project root into the runtime audio directory; no audio edit.
- Attribution required: no project attribution specified
- Redistribution notes: Retain provenance with the project and verify distribution rights for the selected Suno account plan before release.
- Verification notes: Assigned to the campaign map `ThemeMusic` player with autoplay enabled, at a background-music level.
