...
- A high turn-aware three-quarter board view with readable board-edge coordinates, a shoulder follow shot during ordinary movement, and a stormy mountain setting with deterministic lightning. Right-drag orbits, middle-drag pans to any character, and the mouse wheel zooms to face level.
